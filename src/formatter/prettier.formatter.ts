 ...
 * @extends {Formatter}
 */
export class PrettierFormatter extends Formatter {
    /**
    ...
    public async init(): Promise<PrettierFormatter> {
        ...
        if (options) {
            ...
            this.settings = {
                indentationText: this.convertIndentation(
                    this.options.useTabs,
                    this.options.tabWidth
                ),
                insertSpaceAfterOpeningAndBeforeClosingNonemptyBraces:
                    this.options.bracketSpacing !== undefined
                ...
                quoteKind: this.options.singleQuote
                    ...
                    : QuoteKind.Double,
                useTrailingCommas:
                    this.options.trailingComma === "none" ? false : true,
            };
        } else this.settings = {};
