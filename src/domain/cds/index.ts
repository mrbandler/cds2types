...
export const Actions = {
     ...
     */
    isSingleReturnType: (type: ReturnType): type is SingleReturnType =>
        (type as ArrayReturnType).items === undefined,
     ...
     */
    isArrayReturnType: (type: ReturnType): type is ArrayReturnType =>
        (type as ArrayReturnType).items !== undefined,
};
...
export const Types = {
    ...
    isTypeAlias: (type: TypeDef): type is TypeAlias =>
        (type as StructuredType).type !== undefined &&
        (type as EnumType).enum === undefined,
    ...
    isArrayTypeAlias: (type: TypeDef): type is ArrayTypeAlias =>
        (type as StructuredType).type === undefined &&
        (type as ArrayTypeAlias).items !== undefined,
     ...
     */
    areTypeItems: (items: Items): items is TypeItems =>
        (items as TypeItems).type !== undefined,
     ...
     */
    areElementItems: (items: Items): items is ElementItems =>
        (items as ElementItems).elements !== undefined,
     ...
     */
    isStructuredType: (type: TypeDef): type is StructuredType =>
        (type as StructuredType).type === undefined,
     ...
     */
    isReference: (type: Type): type is Reference =>
        (type as Reference).ref !== undefined,
